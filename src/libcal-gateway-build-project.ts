...
export interface ILibCalGatewayBuildProjectProps extends codebuild.PipelineProjectProps {
...
export default class LibCalGatewayBuildProject extends codebuild.PipelineProject {
  constructor(scope: cdk.Construct, id: string, props: ILibCalGatewayBuildProjectProps) {
    const serviceStackPrefix = scope.node.tryGetContext('serviceStackName') || 'libcal-gateway'
    const projectProps = {
      environment: {
