...
import LibCalGatewayBuildProject from './libcal-gateway-build-project'
import LibCalGatewayBuildRole from './libcal-gateway-build-role'
import LibCalGatewayQaProject from './libcal-gateway-qa-project'

const stages = ['test', 'prod']

export interface ILibCalGatewayPipelineStackProps extends cdk.StackProps {
...
export default class LibCalGatewayPipelineStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props: ILibCalGatewayPipelineStackProps) {
    ...
    const codebuildRole = new LibCalGatewayBuildRole(this, 'CodeBuildTrustRole', {
    ...
    // DEPLOY TO TEST
    const deployToTestProject = new LibCalGatewayBuildProject(this, 'LibCalGatewayTestBuildProject', {
      ...props,
      stage: 'test',
      role: codebuildRole,
    })
    ...
    // AUTOMATED QA
    const qaProject = new LibCalGatewayQaProject(this, 'QAProject', {
      stage: 'test',
      role: codebuildRole,
    })
    ...
    // DEPLOY TO PROD
    const deployToProdProject = new LibCalGatewayBuildProject(this, 'LibCalGatewayProdBuildProject', {
      ...props,
      stage: 'prod',
      role: codebuildRole,
    })
    ...
    // AUTOMATED QA
    const prodQaProject = new LibCalGatewayQaProject(this, 'QAProjectProd', {
      stage: 'prod',
      role: codebuildRole,
    })
