...
export interface ILibCalGatewayBuildRoleProps extends RoleProps {
  readonly stages: string[]
  readonly artifactBucket: Bucket
}

export class LibCalGatewayBuildRole extends Role {
  constructor(scope: cdk.Construct, id: string, props: ILibCalGatewayBuildRoleProps) {
...
export default LibCalGatewayBuildRole
